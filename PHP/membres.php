...
<!-- Afficher les vidéos -->
<?php
$req = $conn->query('SELECT * FROM membres');/*Mise en place de la requête préparée pour les membres*/
while ($donnees = $req->fetch()) {/*La requête préparée sert également ici à empêcher les injections SQL*/
    ?>
