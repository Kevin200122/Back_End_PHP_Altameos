...
if (isset($_POST['submit'])) { // Si le formulaire est soumis
    ...
    $confirmation_pass = htmlspecialchars($_POST['confirmation_pass']);
...
<input type="password" name="confirmation_pass" placeholder="Password confirm" class="form-control" id="confirmation_pass">
</div>
<div class="mb-3">
